...
# NUM_SLICES = 32             # number of slices fed to the 3D UNet
NUM_SLICES = 8             # number of slices fed to the 3D UNet
NUM_SLICES_TOTAL = 246      # total number of slices available
