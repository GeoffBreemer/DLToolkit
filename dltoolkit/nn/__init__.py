...
from .miniVGGnet import MiniVGGNN, MINIVGGNET_IMG_CHANNELS, MINIVGGNET_IMG_HEIGHT, MINIVGGNET_IMG_WIDTH, MINIVGGNET_NUM_CLASSES
...
from .generic import CIFAR10_CLASSES, ANIMALS_CLASSES
