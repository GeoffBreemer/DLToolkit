...
from keras.layers import concatenate, Activation, Input, Conv3D, MaxPooling3D, UpSampling3D, Cropping3D, BatchNormalization
...
class UNet_3D_NN(BaseNN):
    ...
    def __init__(self, img_height, img_width, num_slices, img_channels, num_classes, dropout_rate=0.0):
    ...
    def build_model_ORG_MRA(self):
        ...
        print("INPUT HAPE: {} ".format(input_shape))
        ...
        print("conv_scale_up3: {}".format(conv_scale_up3.shape))
        ...
        # print("conv_scale_up2: {}".format(conv_scale_up2.shape))
