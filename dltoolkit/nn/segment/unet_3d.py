...
class UNet_3D_NN(BaseNN):
    ...
    def build_model(self, use_bn=False):
        ...
        """
        if use_bn:
            self._title = "UNet3D_brain_WITH_BN"
        else:
    ...
    def build_model_3lyr(self, use_bn=False):
        ...
        """
        if use_bn:
            self._title = "UNet3D_brain_3layer_WITH_BN"
        else:
            self._title = "UNet3D_brain_3layer_no_BN"
        ...
        pool_contr1 = MaxPooling3D(pool_size=(2, 2, 2), strides=(2, 2, 2), name="contr1_mp")(conv_contr1)
        print("pool_contr1: {}".format(pool_contr1.shape))
        ...
        pool_contr2 = MaxPooling3D(pool_size=(2, 2, 2), strides=(2, 2, 2), name="contr2_mp")(conv_contr2)
        print("pool_contr2: {}".format(pool_contr2.shape))
    ...
    def build_model_2lyr(self, use_bn=False):
        ...
        """
        if use_bn:
            self._title = "UNet3D_brain_2layer_WITH_BN"
        else:
            self._title = "UNet3D_brain_2layer_no_BN"
